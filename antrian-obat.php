        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-header">
              <h2>Antrian Obat</h2>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse fugit fuga nulla id ad numquam as</p>
            </div>
            <iframe src="https://www.rsgs.xyz/simfar/disp" frameborder="0" style="width: 100%; height: 70vh; border-radius: 5px;"></iframe>
          </div>
        </div>
      </div>
      </div>
